...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button launchGolf = (Button) findViewById(R.id.button_launch_app);
        launchGolf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // PebbleKit.startAppOnPebble(getApplicationContext(), Constants.SPORTS_UUID);
                final UUID SPORTS_NEW_UUID = UUID.fromString("8af1665f-9f09-468c-a745-673ed3ecc89d");
                PebbleKit.startAppOnPebble(getApplicationContext(),SPORTS_NEW_UUID);
            }
